...
|  Name:     strings.dart
|
|  Purpose:  all arabic strings use in the software.
|
|  History:
|
|  Date      Release  Name    Ver.    Comments
|  --------- -------  -----   -----   -----------------------------------------
|  06-Sep-20 Alpha    Sohel   $$1     Created
/---------------------------------------------------------------------------- */
String sMembers = 'مشتركين';
String sTrainingSchedules = 'برامج تمارين جاهزة';
String sAddWorkoutSchedule = 'اضافة برنامج تمارين';
String sAddWorkout = 'اضافة تمرين';
...
String sExpiredPlans = "برامج منتهية";
String sPlanData = "تفاصيل";
